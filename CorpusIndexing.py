...
def inverted_index(text):
    ...
    for index, word in word_index(text):
        locations = inverted.setdefault(word, list())
...
if __name__ == '__main__':
    sample1 = """
Vallabhbhai Patel was a political and social leader of India who played a major role in the country's fight for independence and subsequently guided its integration into a united, independent nation. He was called the "Iron Man of India", and was often addressed as "Sardar" which means "Chief" or "Leader" in many languages of India.
"""
